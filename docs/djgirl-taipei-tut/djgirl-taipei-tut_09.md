...
打開瀏覽器進入首頁 [`127.0.0.1:8000/`](http://127.0.0.1:8000/)，可以看到 *post_list* 已呈現至網頁上了。

![Plain post_list in Template](img/plain-post-list-in-template.png)
...
![](img/plain-post-content-in-template.png)
...
打開 [`127.0.0.1:8000/`](http://127.0.0.1:8000/) 看看你的成果吧！

![Django Girls Trips - Home page](img/djangogirlstrips-home.png)
