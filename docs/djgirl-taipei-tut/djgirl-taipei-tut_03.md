...
現在打開瀏覽器輸入 [`127.0.0.1:8000/`](http://127.0.0.1:8000/) 或是 [`localhost:8000/`](http://localhost:8000/)，會看到你的 django 專案已成功在 web server 上執行

![Django startproject success](img/django-startproject-success.png)
