...
*   **需要回傳 `HttpResponse` 物件：** [HttpResponse](https://docs.djangoproject.com/en/1.8/ref/request-response/#httpresponse-objects) 物件裡面包含：
...
有人瀏覽 [`127.0.0.1:8000/hello/`](http://127.0.0.1:8000/hello/) 時 ，`hello_world()` 這個 view function 需要被執行。
...
在瀏覽器輸入 [`127.0.0.1:8000/hello/`](http://127.0.0.1:8000/hello/)，你會看到網頁顯示我們在 HttpResponse 傳入的文字`Hello World!`。

![](img/hello-world-plaintext.png)