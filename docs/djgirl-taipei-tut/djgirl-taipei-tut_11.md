...
1.  註冊 Heroku 帳號：[`id.heroku.com/signup`](https://id.heroku.com/signup)
2.  安裝 Heroku 工具箱：[`toolbelt.heroku.com/`](https://toolbelt.heroku.com/)
...
*   Heroku app 名稱會顯示在 deploy 成功後的網址上，例如：[`djangogirlsdiary.herokuapp.com`](https://djangogirlsdiary.herokuapp.com)
...
你可以分享網址給任何人：[`djangogirlsdiary.herokuapp.com/`](https://djangogirlsdiary.herokuapp.com/)。記得前面要替換成你自己的 Heroku app 名稱！
