...
如果你想要节省时间的话，你可以下载 [microblog-0.8.zip](https://github.com/miguelgrinberg/microblog/archive/v0.8.zip) [https://github.com/miguelgrinberg/microblog/archive/v0.8.zip]。
