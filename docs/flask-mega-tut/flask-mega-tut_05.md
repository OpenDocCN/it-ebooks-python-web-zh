...
我们在 *redirect* 调用中使用的 *url_for* 函数是定义在 Flask 中，以一种干净的方式为一个给定的视图函数获取 URL。如果你想要重定向到首页你可能会经常使用 *redirect(‘/index’)*，但是有很多 [好理由](http://flask.pocoo.org/docs/quickstart/#url-building) [http://flask.pocoo.org/docs/quickstart/#url-building] 让 Flask 为你构建 URLs。
...
如果你想要节省时间的话，你可以下载 [microblog-0.5.zip](https://github.com/miguelgrinberg/microblog/archive/v0.5.zip) [https://github.com/miguelgrinberg/microblog/archive/v0.5.zip]。 
