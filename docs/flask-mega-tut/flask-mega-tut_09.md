...
代码中更新了本文中的一些修改，如果你想要节省时间的话，你可以下载 [microblog-0.9.zip](https://github.com/miguelgrinberg/microblog/archive/v0.9.zip) [https://github.com/miguelgrinberg/microblog/archive/v0.9.zip]。
